...
from time import sleep   # 대기 시간 설정을 위한 라이브러리

# GPIO 핀 번호 지정 및 LED 객체 생성
carLedRed   = LED(17)    # 차량 신호등 - 빨간 LED (GPIO 17번 핀)
carLedBlue  = LED(27)    # 차량 신호등 - 파랑 LED (GPIO 27번 핀)
carLedGreen = LED(22)    # 차량 신호등 - 초록 LED (GPIO 22번 핀)
